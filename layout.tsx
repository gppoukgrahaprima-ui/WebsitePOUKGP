...
const SITE_URL = "https://poukgrahaprima.com";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "id_ID",
    images: [{ url: "/logo-pouk-graha-prima.png", width: 900, height: 900, alt: "Logo POUK Graha Prima" }],
  },
  twitter: { card: "summary_large_image", title: "POUK Graha Prima", description: "Gereja Oikoumene di Tambun Selatan, Bekasi.", images: ["/logo-pouk-graha-prima.png"] },
  icons: {
    icon: [
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  const churchSchema = {
    ...
    image: `${SITE_URL}/logo-pouk-graha-prima.png`,
